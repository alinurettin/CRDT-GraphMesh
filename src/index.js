// CRDT-GraphMesh - Production HTTP Server & OpenMetrics Exporter
...
const PORT = parseInt(process.env.PORT, 10) || 6033;
...
if (require.main === module) {
  startServer(PORT, () => {
    console.log('⚡ CRDT-GraphMesh active at http://localhost:' + PORT);
  });
}
